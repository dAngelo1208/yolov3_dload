...
class BaseConv(nn.Module):
    ...
    def __init__(self, in_chl, out_chl, ksize, stride, with_bn=True, activate='lrelu'):
        ...
        #####
        # 当卷积核的大小等于padding的2倍+1时，图像的输出尺寸等于输入尺寸
        #####
        pad = (ksize - 1) // 2
        ...
        self.activation = get_activation(activate) if activate is not None else None
...
class BasicBlock(nn.Module):
    """
    残差块的实现
    in_chl (1*1 conv)--> down_chl(in_chl/2) (3*3 conv)--> out_chl
    """
